...
data {
  ...
  vector[T] kapital;
  vector[T] q;
   real<lower=0, upper=1> mean_beta; // Known mean of the Beta distribution
  real<lower=0> sd_beta;
} 
transformed data {
  real<lower=0> alpha_beta; // Alpha parameter of the Beta distribution
  real<lower=0> beta_beta;  // Beta parameter of the Beta distribution
...
model {
  ...
  for (t in 2:T) {
    real rho_c = beta_rng(alpha_beta, beta_beta);
      real eta_c = normal_rng(0, sigma_e_c);
