...
model {
  ...
  h ~ beta(.3, 14);  // Beta parameters calculated from mean and standard deviation
  zeta_ws ~ beta(.3, 12);  // Mean=0.5, SD=0.10 implies alpha=beta
...
```
```{r}
fit <- sampling(model, data =data_list , chains = 4, iter = 2000, warmup = 1000)
